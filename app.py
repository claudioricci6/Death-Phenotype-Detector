# ============================================================
#  High-Risk Detector for Solid Pseudopapillary Tumor - Streamlit (TOP-10)
# ============================================================
...
# UI
# ------------------------------------------------------------
st.title(" High-Risk Detector for Solid Pseudopapillary Tumor")
st.markdown("""
Estimate whether a patient’s profile matches a **High-Risk Phenotype-like** pattern  
...
- The apparent (in-sample) discrimination of the model reached an **AUC = 0.891**, while the cross-validated (out-of-sample, single-patient) performance yielded an **AUC = 0.727**. External validation yielded an AUC of 0.975.
